...
xhr.open('GET', '/jsons/class_9th_and_10th/class10th/ncertBooks/politicalScience/api.json', true);
    ...
    lists.forEach(function(element) {
      ...
      let movies = `<div class="col-md-4" id="${element.Ids}" >
         <div class="card mb-4 shadow-sm">
                     <img class="bd-placeholder-img card-img-top" width="100%" height="225" src="/ncertBooks/class_9th_and_10th/class10th/img/politicalScienceCh${element.ChapterNumber}.jpg" alt="">
                     ...
                     <div class="d-flex justify-content-between align-items-start my-2">
                                         ...
                                         <div class="btn-group">
                                              ...
                                              <a href="https://ncert.nic.in/textbook/pdf/jess4${element.ChapterNumber}.pdf">
