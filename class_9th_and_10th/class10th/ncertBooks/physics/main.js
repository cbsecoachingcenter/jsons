...
xhr.open('GET', '/jsons/class_9th_and_10th/class10th/ncertBooks/physics/api.json', true);
    ...
    lists.forEach(function(element) {
      ...
      let movies = `<div class="col-md-4" id="${element.Ids}" >
            <div class="card mb-4 shadow-sm">
                               <img class="bd-placeholder-img card-img-top" width="100%" height="225" src="/ncertBooks/class_9th_and_10th/class10th/img/physicsCh${element.ChapterNumber}.jpg" alt="">
